# ./run.sh 12351 $ACCOUT_NAME $REGION1 $REGION2 $ACCESS_TOKEN $ID_TOKEN
JN_ACCOUNT_ID=$1
ENV_NAME=$2
REGION1=$3
REGION2=$4
...
aws iam attach-role-policy --policy-arn arn:aws:iam::$JN_ACCOUNT_ID:policy/$DEPLOYER_POLICY --role-name $DEPLOYER --no-cli-pager
