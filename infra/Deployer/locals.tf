locals {
  ...
  codebuild_repo               = "${data.terraform_remote_state.docker_repo.outputs.deployer_repo_url}:latest"
  codebuild_role_name          = data.terraform_remote_state.initializer.outputs.deployer_role_name
  codebuild_role_arn           = data.terraform_remote_state.initializer.outputs.deployer_role_arn
  ecr_repo_arn                 = data.terraform_remote_state.docker_repo.outputs.deployer_repo_arn
  ...
  codebuild_project_name       = "Deployer"
