...
module "ecs" {
  ...
  region                        = local.region
  deployer_step_functions_arn   = local.deployer_step_functions_arn
  deployer_step_functions_param = local.deployer_step_functions_param
  tester_step_functions_arn     = local.tester_step_functions_arn
  tester_step_functions_param   = local.tester_step_functions_param
}
